    ...
    abstract class Db
    {
        ...
        public static function getInstance()
        {
            if (self::$conn != null) {
                ...
                //self::$conn = new PDO('mysql:host=localhost;dbname=epiz_23910941_travelinspiration', 'epiz_23910941', 'dusjac-3duzzY-rebkef');
                //self::$conn = new PDO('mysql:host=localhost;dbname=epiz_23910941_travelinspiration', 'epiz_23910941', 'EGmZn9IOQ6lBYa1');
